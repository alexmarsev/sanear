...
namespace SaneAudioRenderer
{
    ...
    public:
        ...
        STDMETHODIMP_(void) SetExtraPrecisionProcessing(BOOL bEnable) override;
        STDMETHODIMP_(BOOL) GetExtraPrecisionProcessing() override;
    ...
    private:
        ...
        BOOL m_extraPrecisionProcessing = FALSE;
    };
}
